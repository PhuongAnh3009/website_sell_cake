<div id="header">
    ...
    <div class="header-body">
        <div class="container beta-relative">
            <div class="pull-left">
                <a href="http://localhost/index" id="logo"><img src="source/assets/dest/images/logo-cake.png"
                                                                width="200px" alt=""></a>
            </div>
                    ...
                    @if(Session::has('cart'))
                        <div class="cart">
                            <div class="beta-select"><i class="fa fa-shopping-cart"></i> Basket
                                (@if(Session::has('cart'))<span id="totalQty">{{Session('cart')->totalQty}}</span> @else
                                    None @endif)
                            ...
                            <div class="beta-dropdown cart-body">
                                ...
                                @foreach($product_cart as $pc)
                                    ...
                                    <div class="cart-item">
                                        ...
                                        <a class="cart-item-delete" href="javascript:void(0)"
                                           link="{{route('del_basket',$pc['item']['id'])}}"
                                           data-quality={{$pc['qty']}} data-price={{$price = $pc['item']['promotion_price']  != 0 ? $pc['item']['promotion_price'] :$pc['item']['unit_price']}}>
                                            <i class="fa fa-times"></i></a>

                                        <div class="media">
                                            <a class="pull-left" href="#"><img
                                                    src="source/image/product/{{$pc['item']['image']}}" alt=""></a>
                                ...
                                <div class="cart-caption">
                                    <div class="cart-total text-right"> Total: <span class="cart-total-value"
                                                                                     id="cart-total" data-total-value={{Session('cart')->totalPrice}}>{{number_format(Session('cart')->totalPrice)}} VND </span>
                                    </div>
                                    ...
                                    <div class="center">
                                        <div class="space10">&nbsp;</div>
                                        <a href="{{route('order')}}" class="beta-btn primary text-center">Đặt hàng <i
