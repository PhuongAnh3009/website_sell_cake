                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    ...
                                    <div class="single-item-header">
                                        <a href="{{route('product_detail', $new->id)}}"><img src="source/image/product/{{$new->image}}" alt=""  height="250px"></a>
                                    </div>
                    ...
                    <div class="beta-products-list">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="{{route('product_detail', $pp->id)}}"><img src="source/image/product/{{$pp->image}}" alt="" height="250px"></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">{{$pp->name}}</p>
                                        <p class="single-item-price" style="margin-bottom: 10px">
                                            <span class="flash-del"> {{number_format($pp->unit_price)}} VND </span>
